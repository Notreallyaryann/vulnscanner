---
name: detecting-security-misconfiguration
description: Check common HTTP configuration weaknesses such as verbose server headers, directory listing hints, and unsafe methods.
---

# Detecting Security Misconfiguration

## Purpose
Check common HTTP configuration weaknesses such as verbose server headers, directory listing hints, and unsafe methods.
