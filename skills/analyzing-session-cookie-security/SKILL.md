---
name: analyzing-session-cookie-security
description: Inspect Set-Cookie attributes for Secure, HttpOnly, SameSite, and overly broad scope.
---

# Analyzing Session Cookie Security

## Purpose
Inspect Set-Cookie attributes for Secure, HttpOnly, SameSite, and overly broad scope.
