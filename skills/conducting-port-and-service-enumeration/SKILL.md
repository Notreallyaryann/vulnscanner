---
name: conducting-port-and-service-enumeration
description: Perform limited TCP service discovery against an explicitly authorized host.
---

# Conducting Port And Service Enumeration

## Purpose
Perform limited TCP service discovery against an explicitly authorized host.
