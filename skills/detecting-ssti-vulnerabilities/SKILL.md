---
name: detecting-ssti-vulnerabilities
description: Identify server-side template indicators in HTML/source and parameter names without sending template-execution payloads.
---

# Detecting Ssti Vulnerabilities

## Purpose
Identify server-side template indicators in HTML/source and parameter names without sending template-execution payloads.
