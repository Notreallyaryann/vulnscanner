...
description: Perform non-destructive API surface and response-header checks for authorized endpoints.
---

# Conducting Api Security Testing

## Purpose
Perform non-destructive API surface and response-header checks for authorized endpoints.
