---
name: analyzing-javascript-dependencies
description: Extract JavaScript dependency names and versions from package metadata and common script URLs; optionally compare against a local advisory JSON file.
---

# Analyzing Javascript Dependencies

## Purpose
Extract JavaScript dependency names and versions from package metadata and common script URLs; optionally compare against a local advisory JSON file.
