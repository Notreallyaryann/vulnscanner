...
description: Detect SSRF risk indicators from application forms and URL parameters without contacting internal/cloud metadata addresses.
---

# Detecting Ssrf Vulnerabilities

## Purpose
Detect SSRF risk indicators from application forms and URL parameters without contacting internal/cloud metadata addresses.
