...
description: Inspect TLS certificate metadata and protocol negotiation for an HTTPS endpoint.
---

# Analyzing Ssl Tls Configuration

## Purpose
Inspect TLS certificate metadata and protocol negotiation for an HTTPS endpoint.
