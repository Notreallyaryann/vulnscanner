...
description: Check common HTTP security headers and identify missing or obviously weak values.
---

# Analyzing Security Headers

## Purpose
Check common HTTP security headers and identify missing or obviously weak values.
