---
name: detecting-cors-misconfiguration
description: Assess CORS response behavior for the supplied origin using a safe preflight-style request.
---

# Detecting Cors Misconfiguration

## Purpose
Assess CORS response behavior for the supplied origin using a safe preflight-style request.
